"""
Connexion Aurora DSQL non-admin (rôle reference_data_api_role, voir
migrations 062-064) et exécution transactionnelle avec retry OCC.
...
DB_USER = os.environ.get("DSQL_APP_USER", "reference_data_api_role")

MAX_RETRIES = 5
BASE_BACKOFF_SECONDS = 0.5
OCC_SQLSTATE = "40001"
UNIQUE_VIOLATION_SQLSTATE = "23505"  # ex. diffusion_partnerships.convention_reference, categories.slug
