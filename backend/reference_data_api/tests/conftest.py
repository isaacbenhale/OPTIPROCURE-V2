"""
Config pytest pour backend/reference_data_api. Copie du conftest.py de
backend/tenders_api/tests (même raison : imports plats, format attendu par
le runtime Lambda, pas de package Python).
"""
import os
import sys
...
sys.path.insert(0, os.path.dirname(_TESTS_DIR))  # backend/reference_data_api/ (imports plats)
